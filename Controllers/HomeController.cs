    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> generateMoodPlaylist(string query)
        {
            ...
            var payload = new
            {
                ...
                messages = new object[]
                {
                    new { role = "system", content = $"Given the user's input of {query}, generate a playlist of 25 songs from Spotify that match the provided {query}. The playlist should include a diverse selection of tracks across different genres and artists, ensuring a cohesive listening experience for the user. Return a list of songs with the format: title - artist."},
